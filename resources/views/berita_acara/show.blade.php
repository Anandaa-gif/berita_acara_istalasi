        ...
        <div class="card-main">
            ...
            <div class="card-body p-0">
                ...
                <div class="action-buttons">
                    <a href="{{ route('berita_acara.index') }}" class="btn btn-secondary btn-custom">
                        <i class="fas fa-arrow-left"></i> Kembali ke Daftar
                    </a>
                    <a href="{{ route('berita_acara.edit', $beritaAcara->id) }}" class="btn btn-warning btn-custom">
                        <i class="fas fa-edit"></i> Edit Data
                    </a>
                    <form action="{{ route('berita_acara.destroy', $beritaAcara->id) }}" method="POST"
                        onsubmit="return confirm('Apakah Anda yakin ingin menghapus data berita acara ini?')"
                        class="d-inline">
                        @csrf
                        @method('DELETE')
