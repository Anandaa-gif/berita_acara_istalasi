                ...
                <tr>
                    ...
                    <td style="width: 50%; text-align: center; vertical-align: bottom; padding: 0 20px;">
                        <div class="signature-container">
                            ...
                            <div class="signature-box">
                                @if ($beritaAcara->tanda_tangan_pelanggan_base64)
                                    <img src="{{ $beritaAcara->tanda_tangan_pelanggan_base64 }}" class="signature-img"
                                        alt="TTD Pelanggan">
                                @else
                    ...
                    <td style="width: 50%; text-align: center; vertical-align: bottom; padding: 0 20px;">
                        ...
                        <div class="signature-container">
                            ...
                            <div class="signature-box">
                                @if ($beritaAcara->tanda_tangan_petugas_base64)
                                    <img src="{{ $beritaAcara->tanda_tangan_petugas_base64 }}" class="signature-img"
                                        alt="TTD Teknisi">
                                @else
                                    <div style="height: 80px; line-height: 80px; color: #999;">Tanda tangan tidak
                                        tersedia</div>
